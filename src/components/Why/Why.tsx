...
export default function Why() {
  return (
    <div className="relative py-20  before:content['a'] before:bg-why before:bg-cover before:absolute before:top-0 before:left-0 before:right-0 before:bottom-0 before:opacity-50 flex flex-col justify-center">
