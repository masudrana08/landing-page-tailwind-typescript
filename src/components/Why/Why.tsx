...
export default function Why() {
  return (
    <div className="relative py-20 md:h-screen before:content['a'] before:bg-why before:bg-cover before:absolute before:top-0 before:left-0 before:right-0 before:bottom-0 before:opacity-50 flex flex-col justify-center">
      ...
      <div className='relative flex flex-col sm:flex-row justify-center items-center gap-5 '>
        <div className="gap-y-1.5 bg-slate-100 w-60 px-4 py-12 flex flex-col items-center text-center ">
